...
public class JWTFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public JWTFilter(JWTUtil jwtUtil, DartsmanDetailsService dartsmanDetailsService) {
        ...
        if (authHeader != null && !authHeader.isBlank() && authHeader.startsWith("Bearer ")) {
            ...
            if (jwt.isBlank()) {
                ...
                try {
                    ...
                    UserDetails userDetails = dartsmanDetailsService.loadUserByUsername(username);
